...
from engine_inference_original import train_one_epoch
from engine_inference_original import evaluate
...
def get_args_parser():
    ...
    parser.add_argument('--skip_empty_patches', action='store_true', help='Skip patches with no objects')
    parser.add_argument('--patch_size', type=int, default=224, help='Size of image patches')
    parser.add_argument('--patch_overlap', type=int, default=32, help='Overlap between patches')
    return parser
...
def main(args):
    ...
    if args.pretrain_model_path:
        ...
        print("_ignorekeywordlist: " + str(_ignorekeywordlist))
